...
%         winsizes = [1280,780;1600,900;1920,1080;2560,1440;3840,2160];
    ...
    methods (Access = private)
        ...
        function ephysplot(guiobj,ax,index,value)
            ...
            plot(ax,guiobj.ephys_taxis,guiobj.ephys_data(index,:))
            axis(ax,'tight')
            if length(index) == 1
        ...
        function imagingplot(guiobj,ax,index,value)
            ...
            plot(ax,guiobj.imaging_taxis,guiobj.imaging_data(index,:))
            axis(ax,'tight')
            if length(index) == 1
                title(ax,value,'Interpreter','none')
            elseif length(index) > 1
                    ...
                    case 2
                        ...
                        if guiobj.datatyp(1)
                            ephysplot(guiobj,guiobj.axes21,...
                                guiobj.ephys_select,...
                                guiobj.ephys_datanames(guiobj.ephys_select))
                        elseif guiobj.datatyp(2)
                            imagingplot(guiobj,guiobj.axes21,...
                                guiobj.imag_select,...
                                guiobj.imag_datanames(guiobj.imag_select))
                        end
                    case 3
                        guiobj.Panel1Plot.Visible = 'off';
                        guiobj.Panel2Plot.Visible = 'off';
...
%         end
        ...
        function runFilt(guiobj,event)
            ...
            datanames = guiobj.ephysProcListBox.String;
            procDatanames = guiobj.ephysProcListBox2.String;
            switch filtype
                case 'DoG'
