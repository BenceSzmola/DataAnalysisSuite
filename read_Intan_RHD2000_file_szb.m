function rhdStruct = read_Intan_RHD2000_file_szb(filename)
...
rhdStruct.filename = filename;
% rhdStruct.path = path;
rhdStruct.notes = notes;
rhdStruct.fs = sample_rate;
rhdStruct.tAxis = linspace(t_amplifier(1),...
    (length(t_amplifier) / sample_rate) + t_amplifier(1), length(t_amplifier));
rhdStruct.frequency_parameters = frequency_parameters;
