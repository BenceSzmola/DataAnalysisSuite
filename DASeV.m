    ...
    methods (Access = private)
        ...
        function eventYlimSetCustomMenuCB(gO)
            ...
            eRawLimsEdit1 = uicontrol(ephysPanel,...
                ...
                'String', num2str(gO.eventYlimCustom_ephys(1,1)));
            eRawLimsEdit2 = uicontrol(ephysPanel,...
                'Style', 'edit',...
                'Units', 'normalized',...
                'Position', [0.75, 0.9, 0.2, 0.075],...
                'String', num2str(gO.eventYlimCustom_ephys(1,2)));
            uicontrol(ephysPanel,...
                'Style', 'text',...
                'Units', 'normalized',...
            ...
            eBpLimsEdit1 = uicontrol(ephysPanel,...
                ...
                'String', num2str(gO.eventYlimCustom_ephys(2,1)));
            eBpLimsEdit2 = uicontrol(ephysPanel,...
                'Style', 'edit',...
                'Units', 'normalized',...
                'Position', [0.75, 0.7, 0.2, 0.075],...
                'String', num2str(gO.eventYlimCustom_ephys(2,2)));
            uicontrol(ephysPanel,...
                'Style', 'text',...
                'Units', 'normalized',...
            ...
            ePowLimsEdit1 = uicontrol(ephysPanel,...
                ...
                'String', num2str(gO.eventYlimCustom_ephys(3,1)));
            ePowLimsEdit2 = uicontrol(ephysPanel,...
                'Style', 'edit',...
                'Units', 'normalized',...
                'Position', [0.75, 0.5, 0.2, 0.075],...
                'String', num2str(gO.eventYlimCustom_ephys(3,2)));
            ...
            iRawLimsEdit1 = uicontrol(imagingPanel,...
                ...
                'Units', 'normalized',...
                'Position', [0.5, 0.9, 0.2, 0.075],...
                'String', num2str(gO.eventYlimCustom_imaging(1,1)));
            iRawLimsEdit2 = uicontrol(imagingPanel,...
                'Style', 'edit',...
                'Units', 'normalized',...
                'Position', [0.75, 0.9, 0.2, 0.075],...
                'String', num2str(gO.eventYlimCustom_imaging(1,2)));
            uicontrol(imagingPanel,...
                'Style', 'text',...
                'Units', 'normalized',...
                'Position', [0.1, 0.7, 0.35, 0.075],...
            ...
            iSmoothLimsEdit1 = uicontrol(imagingPanel,...
                ...
                'Units', 'normalized',...
                'Position', [0.5, 0.7, 0.2, 0.075],...
                'String', num2str(gO.eventYlimCustom_imaging(2,1)));
            iSmoothLimsEdit2 = uicontrol(imagingPanel,...
                'Style', 'edit',...
                'Units', 'normalized',...
                'Position', [0.75, 0.7, 0.2, 0.075],...
                'String', num2str(gO.eventYlimCustom_imaging(2,2)));
            ...
            function saveButtCB
                gO.eventYlimCustom_ephys = [str2double(eRawLimsEdit1.String), str2double(eRawLimsEdit2.String);...
                ...
                gO.eventYlimCustom_imaging = [str2double(iRawLimsEdit1.String), str2double(iRawLimsEdit2.String);...
        ...
        function showKeyShortcutsMenuCB(~,~,~)
            ...
            uicontrol(kbBindsFig,...
                'Style', 'text',...
                'Units', 'normalized',...
                'Position', [0, 0.9, 1, 0.09],...
                'String', 'If then keys don''t seems to work, make sure the focus isn''t on a UI element, and that no special mode is activated (like zoom on an axes)')
            uitable(kbBindsFig,...
                'Data', kbBinds,...
                'ColumnName', colNames,...
