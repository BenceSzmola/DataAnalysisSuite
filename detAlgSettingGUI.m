classdef detAlgSettingGUI < handle
    ...
    properties 
        ...
        settToolTips = struct('debugPlots','Create plots visualizing the algorithm steps',...
                              ...
                              'instPowThrSdMult','Std. multiplier for computing inst. power threshold',...
                              'instEThrSdMult','Std. multiplier for computing inst. energy threshold',...
