function varargout = eventdetGUI_integrated(varargin)
...
% Last Modified by GUIDE v2.5 06-Aug-2019 10:09:27
...
% ingor = handles.vargin;
% [sim_det_gor,doggor,ephys_det_gor,norm_ca_gors,roi_det_gor] = WIP_optimalfilter_withGUI(ingor,hObject,handles);
% handles.vargout = [sim_det_gor,doggor,ephys_det_gor,norm_ca_gors,roi_det_gor];
% set(handles.progress_tag,'Visible','off');
% set(handles.progress_tag,'String','In progress');
% guidata(hObject, handles);
