...
%                 'String',['Null hypothesis - ',char(956),char(8320)]);
%             gO.tTestMu0Edit = uicontrol(gO.tTestSetupPanel,...
%                 'Style','edit',...
%                 'Units','normalized',...
%                 'Position',[0.55, 0.65, 0.3, 0.1],...
%                 'String','0');
...
%                 'Style','text',...
%                 'Units','normalized',...
%                 'Position',[0.1, 0.89, 0.5, 0.1],...
%                 'String','Resulting p-value');
%             gO.tTestResultPText2 = uicontrol(gO.tTestResultPanel,...
%                 'Style','text',...
%                 'Units','normalized',...
%                 'Position',[0.55, 0.89, 0.3, 0.1],...
%                 'String','');
%             gO.tTestResultCIText1 = uicontrol(gO.tTestResultPanel,...
%                 'Style','text',...
%                 'Units','normalized',...
%                 'Position',[0.1, 0.78, 0.5, 0.1],...
%                 'String','Confidence interval');
%             gO.tTestResultCIText2 = uicontrol(gO.tTestResultPanel,...
%                 'Style','text',...
%                 'Units','normalized',...
%                 'Position',[0.55, 0.78, 0.3, 0.1],...
%                 'String','');
%             gO.tTestResultH0Text = uicontrol(gO.tTestResultPanel,...
%                 'Style','text',...
%                 'Units','normalized',...
%                 'Position',[0.1, 0.67, 0.39, 0.1],...
%                 'String','Null hypothesis accepted');
%             gO.tTestResultHAText = uicontrol(gO.tTestResultPanel,...
%                 'Style','text',...
%                 'Units','normalized',...
%                 'Position',[0.51, 0.67, 0.39, 0.1],...
%                 'String','Alternative hypothesis rejected');
