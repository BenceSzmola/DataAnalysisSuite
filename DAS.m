        ...
        function ephysDetRun(guiobj,event)
            ...
            switch dettype
                case 'CWT based'
                    ...
                    dets = wavyDet(data,fs,minlen/1000,sdmult);
                    detinfo = [chan, 1];
...
%             guiobj.
            ...
            guiobj.ephysArtSuppTypePopMenu = uicontrol(guiobj.ephysArtSuppPanel,...
                ...
                'Units','normalized',...
                'Position',[0.01, 0.85, 0.25, 0.1],...
                'String',{'wICA', 'my_wICA','islam2014','other wICA','ACAR/ANC','classic ref subtract'});
